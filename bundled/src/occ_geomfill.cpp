...
void register_occ_geomfill(jlcxx::Module& mod)
{
  ...
  // is deliberately NOT bound here on the occt-7.9.3 branch -- it's a
  // genuinely new-in-8.0.0 OCCT class with no 7.9.3 equivalent at all, not
  // a renamed/moved API. Restore this block when master (OCCT 8.0.0)
